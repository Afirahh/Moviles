...
class PopularMoviePagedListAdapter (public val context: Context) : PagedListAdapter<Movie, RecyclerView.ViewHolder>(MovieDiffCallback()){
    ...
    //Usamos esto para comprobar en cada fila si nos queda espacio o si debemos pasar a la siguiente
    ...
    //Clase que se asegura de que no se repitan peliculas
    ...
    //Clase que controla los datos mostrados y en que pelicula hacemos click
    ...
    //Clase que controla la  visibilidad de errores
    ...
    //Muestra y oculta la barra de progreso
